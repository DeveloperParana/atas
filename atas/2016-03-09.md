...
Decidimos que qualquer institução que ofereça o espaço para realização de eventos do Dev Paraná, deverá permitir que outros eventos que não forem relaizados dentro da referida instituição, possa ser igualmente divulgado para os acadêmicos da mesma. Isso se torna um pré-requisito, para realização de eventos naquela instituição de ensino.
